 ...
 */
package com.wfphantom.redstonequill.detail;
    ...
    public static class TrackTer implements BlockEntityRenderer<RedstoneTrack.TrackBlockEntity> {
        ...
        public static List<ResourceLocation> registerModels() {
            ...
            for (int i = 0; i <= 15; ++i) {
                ...
                power_rgb.add(new Vec3(Mth.clamp(0.01f + f, 0.0F, 1f), Mth.clamp(0.01f + f * 0.4f - .3f, 0.0F, 1f), Mth.clamp(0.01f + f * 0.4f - .2f, 0.0F, 1f)));
            }
